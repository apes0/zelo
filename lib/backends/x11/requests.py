...
RandrGetCrtcTransform = _Request(
    xcb.xcbRandrGetCrtcTransform, xcb.xcbRandrGetCrtcTransformReply
)
RandrSetCrtcConfig = _Request(xcb.xcbRandrSetCrtcConfig, xcb.xcbRandrSetCrtcConfigReply)
XineramaQueryScreens = _Request(
    xcb.xcbXineramaQueryScreens, xcb.xcbXineramaQueryScreensReply
)
