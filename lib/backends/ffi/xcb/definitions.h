...
typedef int xcb_render_fixed_t;
...
typedef struct xcb_randr_get_crtc_transform_reply_t
{
    ...
    unsigned char has_transforms;
    unsigned char pad1[3];
    xcb_render_transform_t current_transform;
    unsigned char pad2[4];
    unsigned short pending_len;
    unsigned short pending_nparams;
    unsigned short current_len;
    unsigned short current_nparams;
...
int xcb_connection_has_error(xcb_connection_t *conn);
void xcb_disconnect(xcb_connection_t *conn);
unsigned int xcb_generate_id(xcb_connection_t *conn);
xcb_screen_t *xcb_aux_get_screen(xcb_connection_t *conn, int screen);
xcb_void_cookie_t xcb_grab_button(xcb_connection_t *conn, unsigned char owner_events, xcb_window_t grab_window, unsigned short event_mask, unsigned char pointer_mode, unsigned char keyboard_mode, xcb_window_t confine_to, xcb_cursor_t cursor, unsigned char button, unsigned short modifiers);
xcb_void_cookie_t xcb_change_window_attributes_checked(xcb_connection_t *conn, xcb_window_t window, unsigned int value_mask, const void *value_list);
xcb_void_cookie_t xcb_ungrab_key(xcb_connection_t *conn, xcb_keycode_t key, xcb_window_t grab_window, unsigned short modifiers);
xcb_void_cookie_t xcb_grab_key(xcb_connection_t *conn, unsigned char owner_events, xcb_window_t grab_window, unsigned short modifiers, xcb_keycode_t key, unsigned char pointer_mode, unsigned char keyboard_mode);
...
xcb_void_cookie_t xcb_configure_window(xcb_connection_t *conn, xcb_window_t window, unsigned short value_mask, const void *value_list);
xcb_void_cookie_t xcb_set_input_focus(xcb_connection_t *conn, unsigned char revert_to, xcb_window_t focus, xcb_timestamp_t time);
...
xcb_void_cookie_t xcb_poly_fill_rectangle(xcb_connection_t *conn, xcb_drawable_t drawable, xcb_gcontext_t gc, unsigned int rectangles_len, const xcb_rectangle_t *rectangles);
xcb_image_t *xcb_image_create_native(xcb_connection_t *conn, unsigned short width, unsigned short height, xcb_image_format_t format, unsigned char depth, void *base, unsigned int bytes, unsigned char *data);
...
xcb_void_cookie_t xcb_create_pixmap(xcb_connection_t *conn, unsigned char depth, xcb_pixmap_t pid, xcb_drawable_t drawable, unsigned short width, unsigned short height);
xcb_void_cookie_t xcb_copy_area(xcb_connection_t *conn, xcb_drawable_t src_drawable, xcb_drawable_t dst_drawable, xcb_gcontext_t gc, short src_x, short src_y, short dst_x, short dst_y, unsigned short width, unsigned short height);
unsigned int xcb_get_maximum_request_length(xcb_connection_t *conn);
...
xcb_get_keyboard_mapping_cookie_t xcb_get_keyboard_mapping(xcb_connection_t *conn, xcb_keycode_t first_keycode, unsigned char count);
...
// xcb_key_symbols_t *keysyms_alloc(xcb_connection_t *conn);
xcb_keycode_t *xcb_key_symbols_get_keycode(xcb_key_symbols_t *syms, xcb_keysym_t keysym);
xcb_key_symbols_t *xcb_key_symbols_alloc(xcb_connection_t *conn);
void xcb_key_symbols_free(xcb_key_symbols_t *syms);
xcb_void_cookie_t xcb_open_font(xcb_connection_t *conn, xcb_font_t fid, unsigned short name_len, const char *name);
xcb_void_cookie_t xcb_image_text_8(xcb_connection_t *conn, unsigned char string_len, xcb_drawable_t drawable, xcb_gcontext_t gc, short x, short y, const char *string);
...
xcb_randr_get_screen_resources_reply_t *xcb_randr_get_screen_resources_reply(xcb_connection_t *conn, xcb_randr_get_screen_resources_cookie_t cookie, xcb_generic_error_t **e);
...
xcb_void_cookie_t xcb_randr_select_input(xcb_connection_t *conn, xcb_window_t window, unsigned short enable);
...
xcb_void_cookie_t xcb_create_glyph_cursor(xcb_connection_t *conn, xcb_cursor_t cid, xcb_font_t source_font, xcb_font_t mask_font, unsigned short source_char, unsigned short mask_char, unsigned short fore_red, unsigned short fore_green, unsigned short fore_blue, unsigned short back_red, unsigned short back_green, unsigned short back_blue);
...
xcb_void_cookie_t xcb_test_fake_input(xcb_connection_t *conn, unsigned char type, unsigned char detail, unsigned int time, xcb_window_t root, short rootX, short rootY, unsigned char deviceid);
const struct xcb_query_extension_reply_t *xcb_get_extension_data(xcb_connection_t *conn, xcb_extension_t *ext);
xcb_get_modifier_mapping_cookie_t xcb_get_modifier_mapping_unchecked(xcb_connection_t *conn);
...
xcb_get_image_cookie_t xcb_get_image(xcb_connection_t *conn, unsigned char format, xcb_drawable_t drawable, short x, short y, unsigned short width, unsigned short height, unsigned int plane_mask);
...
xcb_void_cookie_t xcb_shm_create_pixmap(xcb_connection_t *conn, xcb_pixmap_t pid, xcb_drawable_t drawable, unsigned short width, unsigned short height, unsigned char depth, xcb_shm_seg_t shmseg, unsigned int offset);
xcb_shm_get_image_cookie_t xcb_shm_get_image_unchecked(xcb_connection_t *conn, xcb_drawable_t drawable, short x, short y, unsigned short width, unsigned short height, unsigned int plane_mask, unsigned char format, xcb_shm_seg_t shmseg, unsigned int offset);
...
xcb_void_cookie_t xcb_randr_set_crtc_transform(xcb_connection_t *c, xcb_randr_crtc_t crtc, xcb_render_transform_t transform, unsigned short filter_len, const char *filter_name, unsigned int filter_params_len, const xcb_render_fixed_t *filter_params);
...
xcb_shm create_shm(xcb_connection_t *conn, unsigned long size);
void remove_shm(xcb_connection_t *conn, xcb_shm shm);
