...
sudo apt install -y libxcb-util-dev libx11-xcb-dev libxcb-keysyms1-dev libxcb-image0-dev libxcb-randr0-dev libfontconfig-dev libpango1.0-dev libfreetype6-dev libxcb-xtest0-dev pkg-config python3 build-essential libdbus-glib-1-dev libgirepository1.0-dev xutils-dev xcb-proto libtool autoconf
